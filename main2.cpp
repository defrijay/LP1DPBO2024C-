...
int main()
{
    ...
    dpr.tambahAnggotaDPR(AnggotaDPR(1, "John Doe", "Hukum", "Partai A"));
    dpr.tambahAnggotaDPR(AnggotaDPR(2, "Jane Smith", "Keuangan", "Partai B"));
    ...
    dpr.ubahAnggotaDPR(1, "John Doe", "Pendidikan", "Partai A");
